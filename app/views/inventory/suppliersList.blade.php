...
<div class="panel panel-primary">
	<div class="panel-heading ">
		...
		<div class="panel-btn">
			<a class="btn btn-sm btn-info" href="{{ URL::route('suppliers.create') }}">
				<span class="glyphicon glyphicon-plus-sign"></span>
				{{trans('messages.suppliers')}}
			</a>
...
<table class="table table-striped table-hover table-condensed">
			...
			@foreach($suppliers as $key => $value)
				...
				<tr>
					...
					<a class="btn btn-sm btn-info" href="{{ URL::route('suppliers.edit', array($value->id)) }}" >
					...
					<button class="btn btn-sm btn-danger delete-item-link" 
							...
							data-id="{{ URL::route('suppliers.index', array($value->id)) }}">
