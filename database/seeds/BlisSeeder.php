...
class BlisSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $fields = array(
            ...
            // Lab settings fields
            array(
                "field_name" => "Laboratory Logo", "field_type" => "1", "user_id" => "1", "configurable_id" => "2", "created_at" => $now, "updated_at" => $now
            ),
            array(
                "field_name" => "Laboratory Name", "field_type" => "4", "user_id" => "1", "configurable_id" => "2", "created_at" => $now, "updated_at" => $now
            ),
            array(
                "field_name" => "Telephone", "field_type" => "4", "user_id" => "1", "configurable_id" => "2", "created_at" => $now, "updated_at" => $now
            ),
            array(
                "field_name" => "Address", "field_type" => "5", "user_id" => "1", "configurable_id" => "2", "created_at" => $now, "updated_at" => $now
            ),
            array(
                "field_name" => "Email", "field_type" => "4", "user_id" => "1", "configurable_id" => "2", "created_at" => $now, "updated_at" => $now
            ),
            array(
                "field_name" => "Website", "field_type" => "4", "user_id" => "1", "configurable_id" => "2", "created_at" => $now, "updated_at" => $now
            ),
            array(
                "field_name" => "Director", "field_type" => "4", "user_id" => "1", "configurable_id" => "2", "created_at" => $now, "updated_at" => $now
            ),
            array(
                "field_name" => "Manager", "field_type" => "4", "user_id" => "1", "configurable_id" => "2", "created_at" => $now, "updated_at" => $now
            ),
            array(
                "field_name" => "Quality Manager", "field_type" => "4", "user_id" => "1", "configurable_id" => "2", "created_at" => $now, "updated_at" => $now
            )
        );
