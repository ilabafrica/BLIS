...
<div class="row">
    <div class="col-sm-12">
        <ul class="breadcrumb">
            ...
            <li class="active">{!! trans('action.new').' '.trans_choice('menu.incident-type', 1) !!}</li>
        </ul>
    </div>
</div>
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-pencil"></i> {!! trans('action.new').' '.trans_choice('menu.incident-type', 1) !!} 
		    <span>
	  	...
	  	<div class="card-block">	  		
			...
			@if($errors->all())
            <div class="alert alert-danger alert-dismissible" incident-type="alert">
			...
			{!! Form::open(array('route' => 'incidenttype.store', 'id' => 'form-create-incident-type')) !!}
				<!-- CSRF Token -->
