...
<div class="row">
    <div class="col-sm-12">
        <ul class="breadcrumb">
            ...
            <li class="active">{!! trans('action.edit').' '.trans_choice('menu.sop', 1) !!}</li>
        </ul>
    </div>
</div>
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-edit"></i> {!! trans('action.edit').' '.trans_choice('menu.sop', 1) !!} 
		    <span>
	  	...
	  	<div class="card-block">	  		
			...
			{!! Form::model($sop, array('route' => array('sop.update', $sop->id), 
				'method' => 'PUT', 'id' => 'form-edit-sop')) !!}
				<!-- CSRF Token -->
