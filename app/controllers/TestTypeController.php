...
class TestTypeController extends \BaseController {
	...
	public function apiDatatable(){
        ...
        ->showColumns('name', 'description','targetTAT','prevalence_threshold')
        /*->addColumn('Decription', function($testType){
        	return $testtype->test_categories()->first()->name;
        })*/
        ->addColumn('View', function ($testType) {
