...
<div class="row">
    <div class="col-sm-12">
        <ul class="breadcrumb">
            ...
            <li class="active">{!! trans('action.edit').' '.trans_choice('menu.payment', 1) !!}</li>
        </ul>
    </div>
</div>
<div class="conter-wrapper">
    <div class="card">
        <div class="card-header">
            <i class="fa fa-edit"></i> {!! trans('action.edit').' '.trans_choice('menu.payment', 1) !!} 
            <span>
        ...
        <div class="card-block">
            ...
            {!! Form::model($payment, array('route' => array('payment.update', $payment->id), 
                ...
                <div class="form-group row">
                    {!! Form::label('patient_id', trans_choice('terms.patient_id',1), array('class' => 'col-sm-2 form-control-label')) !!}
                    <div class="col-sm-6">
