...
<div class="row">
    <div class="col-sm-12">
        <ul class="breadcrumb">
            ...
            <li><a href="{!! route('charge.index') !!}"><i class="fa fa-cube"></i> {!! trans_choice('menu.charge', 2) !!}</a></li>
            <li class="active">{!! trans('action.new').' '.trans_choice('menu.charge', 1) !!}</li>
        </ul>
    </div>
</div>
<div class="conter-wrapper">
    <div class="card">
        <div class="card-header">
            <i class="fa fa-pencil"></i> {!! trans('action.new').' '.trans_choice('menu.charge', 1) !!} 
            <span>
        ...
        <div class="card-block">            
            ...
            {!! Form::open(array('route' => 'charge.store', 'id' => 'form-create-charge')) !!}
                <!-- CSRF Token -->
                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                <!-- ./ csrf token -->
                <div class="form-group row">
                    {!! Form::label('name', trans_choice('terms.test_id',1), array('class' => 'col-sm-2 form-control-label')) !!}
                    <div class="col-sm-6">
