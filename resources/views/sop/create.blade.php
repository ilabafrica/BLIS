...
<div class="row">
    <div class="col-sm-12">
        <ul class="breadcrumb">
            ...
            <li class="active">{!! trans('action.new').' '.trans_choice('menu.sop', 1) !!}</li>
        </ul>
    </div>
</div>
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-pencil"></i> {!! trans('action.new').' '.trans_choice('menu.sop', 1) !!} 
		    <span>
	  	...
	  	<div class="card-block">	  		
			...
			{!! Form::open(array('route' => 'sop.store', 'id' => 'form-create-sop')) !!}
				<!-- CSRF Token -->
