...
@endif
	...
	<div>
		<ol class="breadcrumb">
		  ...
		  <li><a href="{{ URL::route('testcategory.index') }}">{{ trans_choice('messages.test-category',1) }}</a></li>
	...
	<div class="panel panel-primary ">
		...
		<div class="panel-body">
			<div class="display-details">
				<h3 class="view"><strong>{{ trans_choice('messages.name',1) }}:</strong>{{ $testcategory->name }} </h3>
