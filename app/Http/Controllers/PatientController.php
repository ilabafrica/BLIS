...
class PatientController extends Controller {
	...
	public function store(PatientRequest $request)
	{
        ...
        return redirect()->to($url)->with('message', trans('general-terms.record-successfully-saved'))->with('active_patient', $patient ->id);
	}
	...
	public function update(PatientRequest $request, $id)
	{
        ...
        return redirect()->to($url)->with('message', trans('general-terms.record-successfully-updated'))->with('active_patient', $patient ->id);
	}
