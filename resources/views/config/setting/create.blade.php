...
<div class="row">
    <div class="col-sm-12">
        <ul class="breadcrumb">
            ...
            <li class="active">{!! trans('messages.new').' '.trans_choice('messages.barcode', 1) !!}</li>
        </ul>
    </div>
</div>
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-pencil"></i> {!! trans('messages.new').' '.trans_choice('messages.barcode', 1) !!} 
		    <span>
	  	...
	  	<div class="card-block">	  		
			...
			{!! Form::open(array('route' => 'barcode.store', 'id' => 'form-create-barcode')) !!}
				<!-- CSRF Token -->
