...
class StockController extends Controller {
	...
	public function store(StockRequest $request)
	{
        ...
        return redirect()->to($url)->with('message', trans('messages.record-successfully-saved'))->with('active_stock', $stock ->id);
	}
	...
	public function update(StockRequest $request, $id)
	{
        ...
        return redirect()->to($url)->with('message', trans('messages.record-successfully-updated'))->with('active_stock', $stock ->id);
	}
	...
	public function stockUsage(UsageRequest $request)
	{
        ...
        return redirect()->to($url)->with('message', trans('messages.record-successfully-saved'))->with('active_stock', 1);
	}
	/**
	 * lot usage
	 *
