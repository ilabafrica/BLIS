...
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-pencil"></i> {!! trans('action.edit').' '.trans_choice('menu.test-type', 1) !!} 
		    <span>
			...
			{!! Form::model($testtype, array('route' => array('testtype.update', $testtype->id), 
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						...
						{!! Form::checkbox(trans('general-terms.culture-worksheet'), "1", $checked, array('onclick'=>'toggle(".organismsClass", this)')) !!}
					</div>
				</div>
