...
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-edit"></i> {!! trans('terms.stock-usage') !!} 
		    <span>
            ...
            <div class="row">
				...
				<div class="col-md-4">
					<ul class="list-group">
						...
						<li class="list-group-item"><h6>{!! trans('terms.lot-no') !!}<small> {!! $lot->stock->lot !!}</small></h6></li>
						<li class="list-group-item"><h6>{!! trans('terms.available-qty') !!}<small> {!! $lot->stock->quantity() !!}</small></h6></li>						
					</ul>
				</div>
			</div>
	  	</div>
