...
class SupplierControllerTest extends TestCase 
{
	...
	public function setVariables(){
		...
		$this->input = array(
			...
			'phone-number' => '0728765432',
			'email' => 'builderone@concretejungle.com',
			'physical-address' => '788347 W3-x2 Down.croncrete',
	...
	public function testStore() 
  	{
		...
		$this->assertEquals($supplierSaved[0]['phone_no'], $this->input['phone-number']);
		$this->assertEquals($supplierSaved[0]['email'], $this->input['email']);
		$this->assertEquals($supplierSaved[0]['physical_address'], $this->input['physical-address']);
  	...
  	public function testUpdate()
	{
		...
		$this->assertEquals($supplierUpdated[0]['phone_no'], $this->inputUpdate['phone-number']);
		$this->assertEquals($supplierUpdated[0]['email'], $this->inputUpdate['email']);
		$this->assertEquals($supplierUpdated[0]['physical_address'], $this->inputUpdate['physical-address']);
