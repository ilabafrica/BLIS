...
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-file-text"></i> <strong>{!! trans('general-terms.details-for').': '.$configurable->name !!}</strong>
		    <span>
		...
		<ul class="list-group list-group-flush">
		    <li class="list-group-item"><h4>{!! trans('general-terms.name').': ' !!}<small>{!! $configurable->name !!}</small></h4></li>
		    <li class="list-group-item"><h5>{!! trans('general-terms.description').': ' !!}<small>{!! $configurable->description !!}</small></h5></li>
	  	</ul>
	</div>
</div>
@endsection	