            ...
            <div class="row">
				...
				<div class="col-md-4">
					<ul class="list-group">
						...
						<li class="list-group-item"><h6>{!! trans('terms.min-level') !!}<small> {!! $stock->item->min_level !!}</small></h6></li>
						<li class="list-group-item"><h6>{!! trans('terms.max-level') !!}<small> {!! $stock->item->max_level !!}</small></h6></li>						
					</ul>
				</div>
			</div>
	  	</div>
