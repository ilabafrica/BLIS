...
<div class="row">
    <div class="col-sm-12">
        <ul class="breadcrumb">
            ...
            <li class="active">{!! trans('messages.edit').' '.trans_choice('messages.stock', 1) !!}</li>
        </ul>
    </div>
</div>
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-edit"></i> {!! trans('messages.edit').' '.trans_choice('messages.stock', 1) !!} 
		    <span>
            ...
            <div class="row">
				...
				<div class="col-md-4">
					<ul class="list-group">
						...
						<li class="list-group-item"><h6>{!! trans('messages.min-level') !!}<small> {!! $stock->item->min_level !!}</small></h6></li>
						<li class="list-group-item"><h6>{!! trans('messages.max-level') !!}<small> {!! $stock->item->max_level !!}</small></h6></li>						
					</ul>
				</div>
			</div>
	  	</div>
