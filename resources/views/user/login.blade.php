    ...
    <body>
        <div class="container login-page">
            <div class="login-form">
                <div class="form-head">
                    <img src="{{ Config::get('blis.organization-logo') }}" alt="" height="90" width="90">
                    <h3> {{ Config::get('blis.organization') }} </h3>
                    @if($errors->all())
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            {{ Form::password("password", array(
                                "placeholder" => trans_choice('messages.password',1),
                                "class" => "form-control"
                            )) }}
                        </div>
                    </div>
                ...
                <div class="smaller-text alone foot">
                    ...
                    <p>
                        {{ Config::get('blis.name') }} - a port of the Basic Laboratory Information System
