...
@endif
	...
	<div>
		<ol class="breadcrumb">
		  ...
		  <li><a href="{{ URL::route('critical.index') }}">{{ Lang::choice('messages.critical',1) }}</a></li>
	...
	<div class="panel panel-primary ">
		...
		<div class="panel-body">
			<div class="display-details">
				<h3 class="view"><strong>{{ Lang::choice('messages.name',1) }}:</strong>{{ $critical->measure->name }} </h3>
