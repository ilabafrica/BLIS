...
@endif
	...
	<div>
		<ol class="breadcrumb">
		  ...
		  <li class="active">{{ trans_choice('messages.item', 1).' '.trans('messages.details') }}</li>
		</ol>
	</div>
	<div class="panel panel-primary ">
		<div class="panel-heading ">
			<span class="glyphicon glyphicon-adjust"></span>
			{{ trans_choice('messages.item', 1).' '.trans('messages.details') }}
			<div class="panel-btn">
		...
		<div class="panel-body">
			<div class="display-details">
				<h3 class="view"><strong>{{ trans_choice('messages.name', 1) }}:</strong>{{ $item->name }} </h3>
