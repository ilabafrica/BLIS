...
class KBLISSeeder extends DatabaseSeeder
{
    public function run()
    {
        ...
        $facilitiesSeed = array(
            array('facility_name', "ST.DAMIANO MEDICAL CENTRE"),
            array('facility_name', "AGA KHAN UNIVERSITY HOSPITAL"),
            array('facility_name', "BUNGOMA DISTRICT HOSPITAL CCC"),
            array('facility_name', "GK PRISON DISPENSARY, BUNGOMA SOUTH"),
            array('facility_name', "KEMRI ALUPE"),
            array('facility_name', "AMPATH"),
            array('facility_name', "BULONDO DISPENSARY"),
            array('facility_name', "BUMULA HEALTH CENTRE"),
            array('facility_name', "CBM NALONDO MODEL"),
            array('facility_name', "CHEBUKAKA MISSION HOSPITAL"),
            array('facility_name', "CHEMWA BRIDGE DISPENSARY"),
            array('facility_name', "CHEPTAIS SUBDISTRICT HOSPITAL"),
            array('facility_name', "CHWELE SUB COUNTY HOSPITAL"),
            array('facility_name', "EKITALE DISPENSARY"),
            array('facility_name', "ELGON VIEW MEDICAL COTTAGE"),
            array('facility_name', "KABUCHAI HEALTH CENTRE"),
            array('facility_name', "KABULA DISPENSARY"),
            array('facility_name', "KAPTANAI DISPENSARY"),
            array('facility_name', "KEMRI NAIROBI"),
            array('facility_name', "KHASOKO HC"),
            array('facility_name', "KIBABII  HEALTH CENTRE"),
            array('facility_name', "KIBUKE DISPENSARY"),
            array('facility_name', "KIMAETI DISPENSARY"),
            array('facility_name', "KIMILILI DISTRICT HOSPITAL"),
            array('facility_name', "KITALE DISTRICT HOSPITAL"),
            array('facility_name', "KOROSIANDET DISPENSARY"),
            array('facility_name', "LUMBOKA MEDICAL SERVICES"),
            array('facility_name', "LUUYA DISPENSARY"),
            array('facility_name', "MACHWELE DISPENSARY"),
            array('facility_name', "MALAKISI HEALTH CENTRE"),
            array('facility_name', "MAYANJA DISPENSARY"),
            array('facility_name', "MECHIMERU DISPENSARY"),
            array('facility_name', "MILUKI DISPENSARY"),
            array('facility_name', "MUMBULE DISPENSARY"),
            array('facility_name', "NALONDO MODEL HEALTH CENTRE"),
            array('facility_name', "NASIANDA DISPENSARY"),
            array('facility_name', "NGALASIA DISPENSARY"),
            array('facility_name', "NZOIA MEDICAL CENTRE"),
            array('facility_name', "NZOIA SUGAR  DISPENSARY"),
            array('facility_name', "SIBOTI MODEL HEALTH CENTRE"),
            array('facility_name', "SIRISIA SUBDISTRICT HOSPITAL"),
            array('facility_name', "TAMLEGA DISPENSARY")
        );
