...
class ItemController extends Controller {
	...
	public function store(ItemRequest $request)
	{
        ...
        return redirect()->to($url)->with('message', trans('general-terms.record-successfully-saved'))->with('active_item', $item ->id);
	}
	...
	public function update(ItemRequest $request, $id)
	{
        ...
        return redirect()->to($url)->with('message', trans('general-terms.record-successfully-updated'))->with('active_item', $item ->id);
	}	
	/**
