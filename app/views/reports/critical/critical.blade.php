...
{{ Form::open(array('route' => array('reports.aggregate.critical'), 'class' => 'form-inline', 'role' => 'form')) }}
<div class="row">
		<div class="col-sm-5">
	    	<div class="row">
				<div class="col-sm-2">
		...
		<div class="table-responsive">
		  ...
		  <table class="table table-striped table-bordered">
		  	<tbody>
		  		...
		  		@forelse($crit[$tc] as $measureId)
		  		<tr>
			  		<td>{{ Measure::find($measureId)->name }}</td>
