...
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-file-text"></i> <strong>{!! trans('terms.details-for').': '.$barcode->name !!}</strong>
		    <span>
		...
		<ul class="list-group list-group-flush">
		    <li class="list-group-item"><h4>{!! trans('terms.name').': ' !!}<small>{!! $barcode->name !!}</small></h4></li>
		    <li class="list-group-item"><h5>{!! trans('terms.description').': ' !!}<small>{!! $barcode->description !!}</small></h5></li>
	  	</ul>
	</div>
</div>
@endsection	