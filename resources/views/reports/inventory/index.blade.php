			...
			<table class="table table-striped table-hover table-condensed search-table">
				@if($selectedReport==0) <!-- monthly Report-->
					<thead>
						<tr>
							<th></th>
							<th>{{trans_choice('messages.commodity',1)}}</th>
							<th>{{trans_choice('messages.supplier',1)}}</th>
							<th>{{trans_choice('messages.batch-no',1)}}</th>
							<th>{{trans_choice('messages.quantity',1)}}</th>
							<th>{{trans_choice('messages.expiry-date',1)}}</th>
							<th>{{trans_choice('messages.qty-issued',1)}}</th>
							<th>{{trans_choice('messages.current-bal',1)}}</th>
						</tr>
					</thead>
					<tbody>
						<?php $i = 1;?>
