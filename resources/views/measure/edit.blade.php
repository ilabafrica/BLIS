    ...
    <div class="col-md-12 measure">
        <div class="col-md-3">
            <div class="form-group row">
                {!! Form::label('measures[name]['.$measure->id.']', trans_choice('general-terms.name', 1).':', array('class' => 'col-sm-3 form-control-label')) !!}
                <div class="col-sm-9">
        ...
        <div class="col-md-3">
            <div class="form-group row">
                {!! Form::label('measures[measure_type_id]['.$measure->id.']', trans('general-terms.type').':', array('class' => 'col-sm-2 form-control-label')) !!}
                <div class="col-sm-10">
        ...
        <div class="col-md-2">
            <div class="form-group row">
                {!! Form::label('measures[unit]['.$measure->id.']', trans('general-terms.unit').':', array('class' => 'col-sm-3 form-control-label')) !!}
                <div class="col-sm-9">
        ...
        <div class="col-md-4">
            <div class="form-group row">
                {!! Form::label('measures[description]['.$measure->id.']', trans('general-terms.info').':', array('class' => 'col-sm-2 form-control-label')) !!}
                <div class="col-sm-8">
        ...
        <div class="col-md-12 card card-block">
            <div class="measurevalue {!!$measure->id!!}">                        
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-sm-4">
                                <select class="col-md-4 c-select form-control" name="measures[{!!$measure->id!!}][gender][]">
                                    <option value="0" {!! $selection[0] !!}>{!! trans_choice('specific-terms.sex', 1) !!}</option>
                                    <option value="1" {!! $selection[1] !!}>{!! trans_choice('specific-terms.sex', 2) !!}</option>
                                    <option value="2" {!! $selection[2] !!}>{!! trans('specific-terms.both') !!}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                ...
                @elseif ($measure->measure_type_id == 2 || $measure->measure_type_id == 3)
                    <div class="col-md-12">
                        <span class="col-md-5 val-title">{!! trans('specific-terms.range') !!}</span>
