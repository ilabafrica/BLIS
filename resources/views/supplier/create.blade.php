...
<div class="conter-wrapper">
	<div class="card">
		<div class="card-header">
		    <i class="fa fa-pencil"></i> {!! trans('messages.new').' '.trans_choice('messages.supplier', 1) !!} 
		    <span>
	  	...
	  	<div class="card-block">	  		
			...
			{!! Form::open(array('route' => 'supplier.store', 'id' => 'form-create-supplier')) !!}
				...
				<div class="form-group row">
					{!! Form::label('phone-no', trans_choice('messages.phone',1), array('class' => 'col-sm-2 form-control-label')) !!}
					<div class="col-sm-6">
