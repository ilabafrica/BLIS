...
<div class="panel panel-primary">
	<div class="panel-heading ">
		...
		<div class="panel-btn">
			...
			<a class="btn btn-sm btn-info" href="{{ URL::route('calibration.index')}}" data-toggle="modal">
				<span class="glyphicon glyphicon-plus-sign"></span>
				{{Lang::choice('messages.calibration', 2)}}
			</a>

			<a class="btn btn-sm btn-info" href="{{ URL::route('maintenance.index')}}" data-toggle="modal">
				<span class="glyphicon glyphicon-plus-sign"></span>
				{{Lang::choice('messages.maintenance', 2)}}
			</a>
		</div>
	</div>
